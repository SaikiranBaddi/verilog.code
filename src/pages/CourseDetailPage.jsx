...
import { 
  ...
  PlayCircle, ArrowRight, ShieldCheck, Share2
} from 'lucide-react';
          ...
          <div className="max-w-4xl space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-6 pt-4 text-xs sm:text-sm text-slate-400 font-medium">
              <div className="flex items-center gap-2">
                ...
                <span>{course.modules?.length || 10} Detailed Modules</span>
              </div>
              <div className="flex items-center gap-2">
                <Clock className="w-4 h-4 text-purple-400" />
                <span>{course.duration || '4 Hours'} Total Time</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                    {course.modules?.length || 10} modules • Click to preview module summary
                  </p>
                </div>
              </div>
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <span className="w-7 h-7 rounded-lg bg-blue-500/10 text-blue-600 dark:text-blue-400 flex items-center justify-center text-xs font-bold">
                            {idx + 1}
                          </span>
            ...
            <div className="p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm sticky top-24">
              ...
              <ul className="space-y-3 text-xs sm:text-sm text-slate-600 dark:text-slate-300 border-b border-slate-100 dark:border-slate-800 pb-4 mb-6">
                ...
                <li className="flex justify-between">
                  ...
                  <span className="font-semibold text-slate-900 dark:text-white">{course.modules?.length || 10}</span>
                </li>
                <li className="flex justify-between">
